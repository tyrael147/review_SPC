...
logger = logging.getLogger(__name__+'elsclient')
class ElsClient:
    ...
    __min_req_interval = 1/5                      ## Min. request interval in secs (5 per sec
    ...
    def exec_request(self, URL):
        ...
        if (interval < self.__min_req_interval):
            ...
            logger.info(f'The searcher is sleeping {self.__min_req_interval - interval} seconds')
